   ...
   public class facturaDTO 
    {
        ...
        public Boolean Entrega { get; set; }
        ...
        public facturaDTO(int idFactura, Boolean Entrega, int Pedido_idPedido, string Pedido_Cliente_DNI, int Repartidor_idRepartidor, int Administrador_idAdministrador) {
        ...
        public static facturaDTO pedidoedtoparalinia(DataGridViewCellCollection row)
        {
            ...
            return new facturaDTO((int)row["idFactura"].Value,(Boolean)row["Entrega"].Value, (int)row["Pedido_idPedido"].Value, (string)row["Pedido_Cliente_DNI"].Value, (int)row["Repartidor_idRepartidor"].Value, (int)row["Administrador_idAdministrador"].Value);
